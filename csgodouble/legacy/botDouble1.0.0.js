...
//Lastest screenshot: http://imgur.com/2yMeCwR
    ...
    opts.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-6">' +
				...
				'Bot controls:<div class="form-group">' +
                    ...
                    '</div>' +
                '</div>' +
                '<a href="" target="_blank">Betting strategy</a>:<div class="form-group">' +
                    '<div class="btn-group">' +
						'<button type="button" class="btn btn-default" id="stratStatic" onclick=stratSet(0)>Static</button>' +
                        '<button type="button" class="btn btn-default" id="stratMartin" onclick=stratSet(1)>Martingale</button>' +
                    '</div>' +
                '</div>' +
                'Color:<div class="form-group automated-hide-on-green">' +
                    '<div class="btn-group">' +
                        '<button type="button" class="btn btn-default" id="betRed" onclick=betSet(0)>Red</button>' +
                        '<button type="button" class="btn btn-default" id="betBlack" onclick=betSet(1)>Black</button>' +
                        '<button type="button" class="btn btn-default" id="betRain" onclick=betSet(2)>Rainbow</button>' +
						'<button type="button" class="btn btn-default" id="betLast" onclick=betSet(3)>Last Roll</button>' +
                        '<button type="button" class="btn btn-default" id="betRand" onclick=betSet(4)>Random</button>' +
                    '</div>' +
                '</div>' +
            '</div>' +
            '<div class="col-lg-3">' +
        ...
        '<div class="form-group">' +
            '<div class="input-group">' +
                '<div class="input-group-addon">Base bet</div>' +
                '<input type="number" class="form-control" placeholder="Set base value" id="wagerBase">' +
            '</div>' +
        '</div>' +
        '<div class="form-group automated-hide-on-green">' +
            '<div class="input-group">' +
                '<div class="input-group-addon">Current calculated bet value</div>' +
                '<input type="number" class="form-control" placeholder="Calculated wager" id="wagerValue">' +
            '</div>' +
        '</div>' +
		'<div class="form-group automated-hide-on-green">' +
            '<div class="input-group">' +
                '<div class="input-group-addon"><input class="" id="betGreen" type="checkbox"> Bet on green</div>' +
                '<input type="number" class="form-control" placeholder="Coins to bet on green" id="wagerGreen">' +
            '</div>' +
        '</div>' +
        '<div class="checkbox">' +
            '<label><input class="" id="simulate" type="checkbox" checked> Check this box if you want to run the bets as a simulation (No coins actually bet)</label>' +
        '</div>';
